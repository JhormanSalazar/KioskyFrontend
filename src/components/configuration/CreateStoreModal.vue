    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-auto max-w-lg overflow-hidden border border-gray-100">
      ...
      <form @submit.prevent="handleSubmit" class="p-6">
        ...
        <div class="form-field">
          ...
          <div class="flex">
            <input
              v-model="storeFormData.domain"
              type="text"
              placeholder="mi-tienda"
              class="w-full px-4 py-2 border border-gray-300 rounded-l-lg focus:ring-2 focus:ring-blue-500 outline-none"
            />
            <span class="inline-flex items-center px-3 bg-gray-50 border border-l-0 border-gray-300 rounded-r-lg text-gray-500 text-sm">
              .com
            </span>
          </div>
        </div>
        ...
        <div class="flex justify-end gap-2">
          ...
          <button
            ...
            class="px-4 py-2 bg-amber-200 hover:bg-amber-100 text-black rounded-lg font-medium transition-colors"
          >
