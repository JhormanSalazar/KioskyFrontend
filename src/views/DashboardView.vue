  ...
  <div class="dashboard-view">
    ...
    <div
      ...
      <div>
        ...
        <p class="text-sm text-gray-400 mt-1 ml-0.5">Bienvenido de vuelta. Aquí tienes un resumen de tu tienda.</p>
      </div>
    </div>
      ...
      <div class="p-6">
        <div class="space-y-4">
          <div class="flex items-center space-x-4">
            ...
            <div class="flex-1">
              <p class="text-sm text-gray-900">Nuevo producto agregado: "Laptop Gaming"</p>
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="flex-1">
              <p class="text-sm text-gray-900">Categoría "Electrónicos" actualizada</p>
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="flex-1">
              <p class="text-sm text-gray-900">Nueva venta realizada</p>
